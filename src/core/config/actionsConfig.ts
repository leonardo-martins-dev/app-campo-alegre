...
export const HUB_ACTIONS: HubAction[] = [
  ...
  },
  {
    ...
    roles: ['supervisor', 'colaborador', 'administracao'],
    icon: 'Users',
    color: '#6366f1',
  },
  {
...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'ver-procedimentos', label: 'Ver Procedimentos', screen: 'VisualizacaoProcedimentos', roles: ['supervisor', 'administracao', 'admin'], icon: 'FileCheck' },
  { id: 'ver-quebra', label: 'Ver Quebra', screen: 'VisualizacaoQuebra', roles: ['supervisor', 'administracao', 'admin'], icon: 'AlertTriangle' },
  { id: 'gestao-usuarios', label: 'Usuários', screen: 'GestaoUsuarios', roles: ['supervisor', 'colaborador', 'administracao'], icon: 'Users' },
